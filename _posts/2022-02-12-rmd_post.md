...
&emsp; &emsp; I wanted to explore discussion around COVID-19 Vaccines on Twitter, with 
recent events surrounding popular speakers like Joe Rogan, and general 
vaccine hestiancy. I used a Twitter dataset by kaushiksuresh147 on Kaggle, 
linked [here](https://www.kaggle.com/kaushiksuresh147/covidvaccine-tweets), including all public tweets
since January 2020 that use the hashtag #CovidVaccine. I attempted to group these 
tweets by vaccine sentiment, and while exploring a variety of metrics, found some interesting results.


 
&emsp; &emsp; As the #CovidVaccine tweets were defined by their use of the hashtag, I
looked to the tweet's other hashtags to determine anti-vaccine sentiment. I discovered many popular anti-vax tags, including #Plandemic, #COVID1984, and #CovidHoax.
...
![](/assets/img/age_plot_img.png)


&emsp; &emsp; The COVID-19 pandemic brought unprecedented social upheaval with it.
